...
input_frame = tkinter.Frame(root,padx=5,pady=5)
output_frame = tkinter.Frame(root,padx=5,pady=5)
input_frame.pack(fill=BOTH,expand=True,padx=5,pady=5)
output_frame.pack(fill=BOTH,expand=True,padx=5,pady=5)

# defining the sliders and major color buttons
...
# inserting the buttons and sliders into the window
...
# defining the color box and tuples for storing the color
...
# defining the loop to change the color when sliders are moved
for i in range(6):
...
# defining global variables to store color values
red_value = '00'
green_value = '00'
blue_value = '00'
